    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <form action="{{ route('admin.menus.update', $menu) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <x-text-input id="url" class="block mt-1 w-full" type="text" name="url" :value="old('url', $menu->url)"
                    required />
            ...
            <div class="mb-4">
                ...
                <x-text-input id="order" class="block mt-1 w-full" type="number" name="order" :value="old('order', $menu->order)"
                    required />
